  ...
  let aq = forecast.forecast.forecastday[day].day.air_quality;
    ...
    return(
        <>
            ...
            The index categorizes air pollution levels and provides health advice based on these levels.
            The index is rated from 1 to 10, where 1 means the lowest pollution level and 10 the highest. 
            In the app we present reversed index - as to highlight the positives. 10 means the best air quality, 1 the worst.
            </p>
            <h2>Details</h2>
            <table>
                <tr>
                ...
                <tr>
                  <td>PM2.5</td>
                  <td className='line'>             
                    <Line percent={(aq.pm2_5)/75*100} strokeWidth={3} strokeColor={pm2_5LineColor(aq.pm2_5)} trailColor='#fff' />
                  </td>
                ...
                <tr>
                  <td>PM10</td>
                  <td>             
                  <Line percent={(aq.pm10)/110*100} strokeWidth={3} strokeColor={pm10LineColor(aq.pm10)} trailColor='#fff' />
                  </td>
                ...
                <tr>
                  <td>O3</td>
                  <td>             
                  <Line percent={(aq.o3)/180*100} strokeWidth={3} strokeColor={o3LineColor(aq.o3)} trailColor='#fff' />
                  </td>
                ...
                <tr>
                  <td>NO2</td>
                  <td>             
                  <Line percent={(aq.no2)/230*100} strokeWidth={3} strokeColor={no2LineColor(aq.no2)} trailColor='#fff' />
                  </td>
                ...
                <tr>
                  <td>SO2</td>
                  <td>             
                  <Line percent={(aq.so2)/350*100} strokeWidth={3} strokeColor={so2LineColor(aq.so2)} trailColor='#fff' />
                  </td>
